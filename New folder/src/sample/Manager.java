...
public class Manager extends Employee{
    ...
    public void addManager() throws FileNotFoundException {
        File file1=new File("F:\\java intellj projects\\oop_project_javafx\\src\\sample\\managers.txt");
        String inputText1="";
    ...
    public void showManager() throws FileNotFoundException {
        File file1=new File("F://java intellj projects//oop second look//oop project//com//company//managers.txt");
        String inputText1="";
        Scanner reader = new Scanner(file1);
        while(reader.hasNext())//display the contents of file as well
        {
