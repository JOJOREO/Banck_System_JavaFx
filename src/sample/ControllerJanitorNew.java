...
public class ControllerJanitorNew {
    ...
    public void fill(ActionEvent event) throws Exception
    {
        ...
        try {
            ...
            if(rb1.isSelected())
                ...
                a1.present=false;
            a1.numberWindowsCleaned=Integer.parseInt(txt8.getText());
            a1.numberOfCleaningBottlesUsed=Integer.parseInt(txt9.getText());
            a1.numberOfTimesVacumedFLoor=Integer.parseInt(txt10.getText());
            a1.addJanitor();
            lb11.setText("Janitor ADDED SUCCESFULLY");
