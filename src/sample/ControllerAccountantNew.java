...
public class ControllerAccountantNew {
    ...
    public void fill(ActionEvent event) throws Exception
    {
        ...
        try {
            ...
            if(rb1.isSelected())
                ...
                a1.present=false;
            a1.numberOfAccountsOpened=Integer.parseInt(txt8.getText());
            a1.numberOfTransactions=Integer.parseInt(txt9.getText());
            a1.numberOfAccountsReviewed=Integer.parseInt(txt10.getText());
            a1.addAccountant();
            lb11.setText("ACCOUNTANT ADDED SUCCESFULLY");
