...
public class ControllerGuardNew {
    guard a1 = new guard();
    ...
    public void fill(ActionEvent event) throws Exception
    {
        ...
        try {
            ...
            if(rb1.isSelected())
                ...
                a1.present=false;
            a1.numberOfThievesCaught=Integer.parseInt(txt8.getText());
            a1.numberOfBulletsShot=Integer.parseInt(txt9.getText());
            a1.numberOfDaysOff=Integer.parseInt(txt10.getText());
            a1.addGuard();
            lb11.setText("GUARD ADDED SUCCESFULLY");
