...
public class ControllerEmployee {
    ...
    public Button ceo;
    @FXML
    public void opentable7(ActionEvent event) throws Exception
    {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("ceo.fxml"));
            Parent root1 = (Parent) fxmlLoader.load();
            Stage stage = new Stage();
            stage.setTitle("show all in AAST BANK");
            stage.setScene(new Scene(root1));
            stage.show();
        } catch(Exception e) {
            e.printStackTrace();
    ...
    public Button Hr;
    @FXML
    public void opentable8(ActionEvent event) throws Exception
    {
        try {
