...
public class ControllerCurrencyExchangerNew {
    currencyExchanger a1 = new currencyExchanger();
    ...
    public void fill(ActionEvent event) throws Exception
    {
        ...
        try {
            ...
            if(rb1.isSelected())
                ...
                a1.present=false;
            a1.amountEntered=Integer.parseInt(txt8.getText());
            a1.amountOutput=Integer.parseInt(txt9.getText());
            a1.numofExchanges=Integer.parseInt(txt10.getText());
            a1.addCurrencyExchanger();
            lb11.setText("CurrencyExchanger ADDED SUCCESFULLY");
