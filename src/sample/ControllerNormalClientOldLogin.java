...
public class ControllerNormalClientOldLogin {
    ...
    public void fill(ActionEvent event) throws Exception
    {
        ...
        try {
            ...
            String inputToFile1=a2.name+","+a2.ssn+","+a2.address+","+a2.phone+","+a2.username+","+a2.pinCode+","+a2.balance+","+a2.amount+","+a2.oldLoan+","+"normal";
