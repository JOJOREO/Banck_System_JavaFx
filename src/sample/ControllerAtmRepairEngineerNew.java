...
public class ControllerAtmRepairEngineerNew {
    atmRepairEngineer a1 = new atmRepairEngineer();
    ...
    public void fill(ActionEvent event) throws Exception
    {
        ...
        try {
            ...
            if(rb1.isSelected())
                ...
                a1.present=false;
            a1.numberOfErrorsFixed=Integer.parseInt(txt8.getText());
            a1.numberOfMachinesFixed=Integer.parseInt(txt9.getText());
            a1.amountOfMoneyPlacedInMachine=Integer.parseInt(txt10.getText());
            a1.addAtmRepairEngineer();
            lb11.setText("AtmRepairEngineer ADDED SUCCESFULLY");
